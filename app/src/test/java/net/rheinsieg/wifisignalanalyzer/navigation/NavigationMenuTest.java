...
import net.rheinsieg.wifisignalanalyzer.navigation.availability.NavigationOptionFactory;
import net.rheinsieg.wifisignalanalyzer.navigation.items.NavigationItemFactory;
...
public class NavigationMenuTest {
    ...
    public void testGetNavigationItem() {
        Assert.assertEquals(NavigationItemFactory.ACCESS_POINTS, NavigationMenu.ACCESS_POINTS.getNavigationItem());
    ...
    public void testGetNavigationOptions() {
        Assert.assertEquals(NavigationOptionFactory.AP, NavigationMenu.ACCESS_POINTS.getNavigationOptions());
