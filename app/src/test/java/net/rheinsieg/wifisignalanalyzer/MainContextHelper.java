...
public enum MainContextHelper {
    ...
    public FreifunkService getFreifunkService() {
        FreifunkService result = (FreifunkService) save(FreifunkService.class, mainContext.getFreifunkService());
        mainContext.setFreifunkService(result);
        return result;
    }
    ...
    private class RestoreClosure implements Closure<Class<?>> {
        ...
        public void execute(Class<?> input) {
            ...
            } else if (input.equals(FreifunkService.class)) {
                mainContext.setFreifunkService((FreifunkService) result);
