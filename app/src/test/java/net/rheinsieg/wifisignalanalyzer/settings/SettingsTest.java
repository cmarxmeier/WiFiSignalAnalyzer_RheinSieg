...
import net.rheinsieg.util.LocaleUtils;
import net.rheinsieg.wifisignalanalyzer.R;
import net.rheinsieg.wifisignalanalyzer.navigation.NavigationMenu;
import net.rheinsieg.wifisignalanalyzer.wifi.accesspoint.AccessPointViewType;
import net.rheinsieg.wifisignalanalyzer.wifi.accesspoint.ConnectionViewType;
