...
import net.rheinsieg.wifisignalanalyzer.vendor.model.VendorServiceFactory;
import net.rheinsieg.wifisignalanalyzer.freifunk.model.FreifunkService;
import net.rheinsieg.wifisignalanalyzer.freifunk.model.FreifunkServiceFactory;
import net.rheinsieg.wifisignalanalyzer.wifi.filter.adapter.FilterAdapter;
import net.rheinsieg.wifisignalanalyzer.wifi.scanner.ScannerService;
import net.rheinsieg.wifisignalanalyzer.wifi.scanner.ScannerServiceFactory;
...
public enum MainContext {
    ...
    public FreifunkService getFreifunkService() {
        return freifunkService;
    }

    void setFreifunkService(FreifunkService freifunkService) { this.freifunkService = freifunkService; }
    ...
    void initialize(@NonNull MainActivity mainActivity, boolean largeScreen) {
        ...
        setFreifunkService(FreifunkServiceFactory.makeFreifunkService(mainActivity.getResources()));
