...
import static net.rheinsieg.wifisignalanalyzer.InstrumentedUtils.ChildAtPosition;
import static net.rheinsieg.wifisignalanalyzer.InstrumentedUtils.pauseLong;
import static net.rheinsieg.wifisignalanalyzer.InstrumentedUtils.pauseShort;
import static net.rheinsieg.wifisignalanalyzer.InstrumentedUtils.pressBackButton;
    ...
    private void selectMenuItem(int menuItem) {
        ...
        ViewInteraction appCompatImageButton = onView(
            allOf(withContentDescription(NAVIGATION_DRAWER_TAG),
                new ChildAtPosition(Matchers.allOf(ViewMatchers.withId(R.id.toolbar),
                    new ChildAtPosition(
